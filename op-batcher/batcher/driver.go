...
func (l *BatchSubmitter) GetCelestiaLocation(ctx context.Context, l2Block uint64) (*celestia.CelestiaLocation, error) {
	return l.DAClient.Indexer.GetCelestiaLocation(l2Block)
}
